...
target_path = r"g:\Meu Drive\11 - Empresa - Descartex\Projetos IA\financeiro\templates\financeiro\account_payable_list_SAFE.html"
            ...
            <form method="get" class="row g-3">
                <div class="col-md-3">
                    ...
                    <select name="supplier" class="form-select select2">
                        ...
                        {% for s in suppliers %}
                        <option value="{{ s.id }}" {% if request.GET.supplier == s.id|stringformat:"i" %}selected{% endif %}>{{ s.name }}</option>
                        {% endfor %}
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="originalAmountDisplay" class="form-control" readonly>
                        </div>
                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const displayOriginal = document.getElementById('originalAmountDisplay');
        ...
        function updateTotal() {
            ...
            // Format for display
            // Using replace to format as BR standard if needed by field, but step='any' usually accepts . 
            // We'll stick to fixed(2) and let the browser/Django handle.
            // But visually we often want comma. Let's try sending standard dot for value.
        ...
        document.querySelectorAll('.btn-pay').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Parse float from comma string if needed
                let rawAmount = this.dataset.amount.replace(',', '.');
                currentOriginalAmount = parseFloat(rawAmount); 
