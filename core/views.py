...
def get_permissions_from_mapping():
    ...
    import re
    APP_LABELS_BR = {
        'core': 'Cadastros Base (Pessoas/Serviços)',
        'comercial': 'Comercial (Contratos/Orçamentos)',
        'financeiro': 'Financeiro (Contas/Movimentações)',
        'operacional': 'Operacional (Ordens de Serviço)',
        ...
        'ai_core': 'Inteligência Artificial (Studio AI)',
        'importador': 'Importador de Dados',
        'auth': 'Acessos e Segurança (Usuários/Perfis)',
    ...
    MODEL_NAMES_BR = {
        ...
        'person': 'pessoa/cliente',
        'technician': 'técnico',
        'atendimentoai': 'atendimento com IA',
        'empresa': 'empresa emissora (NFS-e)',
        'nfse': 'NFS-e Nacional',
        'coraconfig': 'configuração Cora',
        'boletocora': 'boleto Cora',
        'importtemplate': 'template de importação',
        'importjob': 'trabalho de importação',
        'importerror': 'erro de importação',
        'modulefield': 'campo de módulo',
        'serviceorder': 'ordem de serviço',
        'os anexo': 'anexo de OS',
        'service order item': 'item de OS',
        'checklist categoria': 'categoria de checklist',
        'checklist pergunta': 'pergunta de checklist',
        'checklist resposta': 'resposta de checklist',
        'billing group': 'grupo de faturamento',
        'contract template': 'modelo de contrato',
        'contract': 'contrato',
        'contract item': 'item de contrato',
        'budget': 'orçamento',
        'budget product': 'produto do orçamento',
        'budget service': 'serviço do orçamento',
        'financial category': 'categoria financeira',
        'cash account': 'conta bancária',
        'financial transaction': 'movimentação financeira',
        'cost center': 'centro de resultado',
        'account payable': 'conta a pagar',
        'account receivable': 'conta a receber',
        'bank reconciliation': 'reconciliação bancária',
        'receipt': 'recibo',
        'budget plan': 'planejamento orçamentário',
        'budget item': 'item de orçamento',
