...
path = r'g:\Meu Drive\11 - Empresa - Descartex\Projetos IA\operacional\templates\operacional\operational_dashboard.html'
                    ...
                    <div id="os-{{ os.id }}" class="card mb-2 border-0 shadow-sm border-start border-4 border-info">
                        <div class="card-body p-3">
                            ...
                            <div class="d-grid mt-3">
                                <a href="{% url 'operacional:service_order_detail' os.pk %}" class="btn btn-sm btn-outline-info">Ver Detalhes</a>
                            </div>
                        </div>
                    </div>
                    {% empty %}
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 bg-light border-0 shadow-sm">
                ...
                <div class="card-body overflow-auto p-2" style="max-height: 70vh; min-height: 300px;">
                    ...
                    <div id="os-{{ os.id }}" class="card mb-2 border-0 shadow-sm border-start border-4 border-primary {% if selected_os.id == os.id %}ring-4 ring-primary bg-primary bg-opacity-10{% endif %}" {% if selected_os.id == os.id %}style="border: 2px solid #0d6efd !important;"{% endif %}>
                        <div class="card-body p-3">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <span class="fw-bold fs-6">#{{ os.id|stringformat:"06d" }}</span>
                            ...
                            <div class="d-grid mt-3">
                                <a href="{% url 'operacional:service_order_detail' os.pk %}" class="btn btn-sm btn-outline-primary">Ver Detalhes</a>
                            </div>
                        </div>
                    </div>
                    {% empty %}
                ...
                <div class="card-body overflow-auto p-2" style="max-height: 70vh; min-height: 300px;">
                    ...
                    <div id="os-{{ os.id }}" class="card mb-2 border-0 shadow-sm border-start border-4 border-warning">
                        <div class="card-body p-3">
                            ...
                            <div class="d-grid mt-3">
                                <a href="{% url 'operacional:service_order_detail' os.pk %}" class="btn btn-sm btn-outline-warning text-dark">Ver Detalhes</a>
                            </div>
                        </div>
                    </div>
                    {% empty %}
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(content)
print('Successfully overwritten operational_dashboard.html')
