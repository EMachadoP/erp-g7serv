...
# Define path
file_path = r'g:\Meu Drive\11 - Empresa - Descartex\Projetos IA\operacional\templates\operacional\clean_dashboard.html'

# Content - ensuring single line tags and no weird chars
# We use raw strings and careful concatenation
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="alert alert-info d-none">
        <strong>Debug Probe:</strong> Django is rendering. 
        Context Check: {{ budgets_to_approve|length }} items.
    </div>
    <!-- DEBUG BLOCK END -->
                ...
                <div class="card-body py-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ budgets_pending_contract|length }}</div>
                        </div>
                ...
                <div class="card-body py-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ budgets_pending_os|length }}</div>
                        </div>
                ...
                <div class="card-body py-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ os_in_progress|length }}</div>
                        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card h-100 bg-light border-0 shadow-sm">
                <div class="card-header bg-white border-bottom fw-bold py-3 text-primary d-flex justify-content-between align-items-center">
                    <span>Liberação</span>
                    <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill">{{ budgets_to_approve|length }}</span>
                </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card h-100 bg-light border-0 shadow-sm">
                <div class="card-header bg-white border-bottom fw-bold py-3 text-warning d-flex justify-content-between align-items-center">
                    <span>Contratos</span>
                    <span class="badge bg-warning bg-opacity-10 text-dark rounded-pill">{{ budgets_pending_contract|length }}</span>
                </div>
                <div class="card-body overflow-auto p-2" style="max-height: 70vh; min-height: 300px;">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card h-100 bg-light border-0 shadow-sm">
                <div class="card-header bg-white border-bottom fw-bold py-3 text-info d-flex justify-content-between align-items-center">
                    <span>Gerar OS</span>
                    <span class="badge bg-info bg-opacity-10 text-info rounded-pill">{{ budgets_pending_os|length }}</span>
                </div>
                <div class="card-body overflow-auto p-2" style="max-height: 70vh; min-height: 300px;">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card h-100 bg-light border-0 shadow-sm">
                <div class="card-header bg-white border-bottom fw-bold py-3 text-success d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-success bg-opacity-10 text-success rounded-pill">{{ os_in_progress|length }}</span>
                </div>
                <div class="card-body overflow-auto p-2" style="max-height: 70vh; min-height: 300px;">
